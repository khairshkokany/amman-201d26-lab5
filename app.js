...
Write a function called multiply() that takes in two numbers as arguments and returns an array where the
 first element is the product of those numbers, 
...
function sumAndMultiply(a, b, c) {
  ...
  let sum1=sum(a,b)[0];
  let answerSum=sum(sum1,c)[0];
  let multiply1=multiply(a,b)[0];
  let answerMultiply=multiply(multiply1,c)[0];
...
function sumArray(sumArr) {
  ...
  let answerSum=sum(sum2,sumArr[2])[0];
  console.log(answerSum);
  return[answerSum,`${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${answerSum} is their sum.`]
...
function multiplyArray(multArr) {
  ...
  let answerMultiply=multiply(multiply2,multArr[2])[0];
  console.log(answerMultiply);
  return[answerMultiply,`The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${answerMultiply}.`]
